  ...
  <body>
          ...
          <div class="row align-items-center">
            <div class="col-lg-4">
              <ul class="list-inline mb-0 text-sm">
                <li class="list-inline-item"><a class="reset-anchor" href="#!">Apie mus</a></li>
    ...
    <section class="py-5">
      <div class="container text-center">
        <p class="h6 mb-0 text-uppercase text-primary">Lankytinos vietos</p>
        <h1>Stiklo kvartalas</h1>
        <ul class="list-inline small text-uppercase mb-0">
          
          <li class="list-inline-item text-muted align-middle me-0">|</li>
          <li class="list-inline-item text-muted align-middle me-0">Gegužės 15, 2019</li>
          <li class="list-inline-item text-muted align-middle me-0">|</li>
          <li class="list-inline-item text-muted align-middle">20 Komentarų</li>
        </ul>
      </div><div class="katedrosDivas"><img class="w-100 py-5" id="katedra" src="img/stiklas.jpg" alt=""></div>
      <div class="container">
        <div class="row gy-5">
          <div class="col-lg-8">
            <p class="lead first-letter-styled lh-4">Stiklo kvartalas Vilniuje – paslėptas vilnietiškos kultūros lobis. Jau daugiau nei 600 metų skaičiuojantis kvartalas, kadaise užėmęs didžiąją dabartinio Senamiesčio dalį, buvo žydų gyvenamoji vieta, auksakalių, stiklapūčių, amatininkų ir finansininkų miestelis. 1495 m. čia buvo įkurta auksakalių gildija, 1547 m. – pirmoji LDK stiklo manufaktūra, o kvartalo pavadinimas gimė 2018 m. įsikūrus tvirtai bendruomenei, primindamas laikus, kai čia buvo net trys Stiklo vardo gatvės; Stiklo 1-oji, Stiklo 2-oji ir Stiklo 3-oji.

Tarsi paslėptas tarp didžiųjų miesto gatvių, kvartalas iki šiol glaudžia juvelyrus, vietos menininkų, amatininkų krautuvėles ir dirbtuves, jaukius restoranus, kamerinį orkestrą, meno galerijas ir vieną seniausių veikiančių „Stiklių“ viešbutį.</p>
            <div class="px-lg-5 mb-5">
            </div>
            <h2>Pažinkite žydiškąjį paveldą</h2>
            <p class="text-muted mb-4">tekstas tekstas tekstas</p>
                 <h2>Angelas</h2>
            <p class="text-muted mb-4">Sklando legenda, kad Angelo vietą pasiūlė Dalai Lama vieno savo vizito į Vilnių metu. Tačiau tiesa taip pat labai graži – užupiečiai ieškojo vietos, kur galėtų įamžinti Užupio angelą sargą Zenoną Šteinį, menininką ir aktyvų bendruomenės narį.
                Tai jis padėjo paversti ne patį gražiausią ir ramiausią rajoną tokiu Užupiu, kokį matome šiandien.</p><img class="img-fluid mb-4" src="img/angelas.jpg" alt="">
                <h2>Likimo sūpynės</h2>
            <p class="text-muted mb-4">Sužinokite, ką jums lėmė likimas – nusileiskite po Užupio tiltu ir pažiūrėkite, ar upės vanduo leis pasisupti Likimo sūpynėse.

Pasukite galvą į šoną ir pamatysite, kad į jus žvelgia kita Užupio paslaptis – Undinėlė. 2004 m. potvynio metu ji nusprendė panardyti, bet grįžo namo ir dabar vėl sėdi krantinės nišoje.
 Tik atsargiai, jei išgirsite jos giesmę, galite susivilioti Užupyje likti amžinai.</p><img class="img-fluid mb-4" src="img/supynes.jpg" alt="">
            <ul class="list-check text-muted text-sm mb-5">
            <li class="mb-1">Vilniaus katedros požemiai lankomi tik su ekskursijomis. </li>
            <li class="mb-1">Ekskursiją galima užsisakyti I–VI 10.00–16.00. Ekskursijos trukmė – 1 val. </li>
            <li class="mb-1">Gido paslaugų kainos: lietuvių kalbą 20eur, užsienio kalba 30 eur. </li>
            <li class="mb-1">Ekskursijos vedamos suaugusių grupėms nuo 10 iki 30 asmenų, vaikų ir moksleivių grupėms – nuo 15 iki 30 asmenų. Vienu metu galima registruoti dvi grupes.</li>
            <li class="mb-1">Ekskursijos lietuvių kalba: Šeštadieniais 15.30 val. Ekskursijos anglų kalba: Antradieniais, ketvirtadieniais ir šeštadieniais 16.00 val.   </li>
            <li class="mb-1">Į visas ekskursijas Vilniaus katedros požemiuose būtina išankstinė registracija tel. + 370 600 12080, + 370 5 269 7800, el. p. katedrospozemiai@bpmuziejus.lt</li>
            <h3 class="mb-4"><BR>Ekskursijos</h3>
            <ul class="list-check text-muted text-sm mb-5">
            ...
            <h3 class="h4 mb-4">Pasidalinkite.</h3>
            ...
            <h3 class="h4 mb-4">Palikite atsiliepimą</h3>
            <form class="mb-5" action="#">
              <div class="row gy-3">
                <div class="col-lg-6">
                  <input class="form-control" type="text" name="name" placeholder="Pilnas vardas pvz.: Saulius Saulaitis">
                </div>
                <div class="col-lg-6">
                  <input class="form-control" type="email" name="email" placeholder="EL.pašto adresas pvz.: Tomas@email.com">
                </div>
                <div class="col-lg-12">
                  <textarea class="form-control" name="message" rows="5" placeholder=""></textarea>
                </div>
                <div class="col-lg-12">
                  <button class="btn btn-dark" type="submit">Palikite savo atsiliepimą.</button>
                </div>
              </div>
            </form>
            <h3 class="h4 mb-4 d-flex align-items-center"><span>Comments</span><span class="text-sm ms-3 text-gray">- 3 Komentarai</span></h3>
