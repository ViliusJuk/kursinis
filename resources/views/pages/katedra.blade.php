...
<html>
  ...
  <body>
    ...
    <section class="py-5">
      ...
      </div><div class="katedrosDivas"><img class="w-100 py-5" id="katedra" src="img/katedrav.jpg" alt=""></div>
      <div class="container">
        <div class="row gy-5">
          <div class="col-lg-8">
            <p class="lead first-letter-styled lh-4">Vilniaus šv. vyskupo Stanislovo ir šv. Vladislovo arkikatedra bazilika (arba tiesiog Vilniaus katedra) – svarbiausia Lietuvos katalikų bažnyčia ir reikšmingiausias klasicizmo architektūros pavyzdys šalyje.
                 Katalikiškos piligrimystės vieta Vilniaus arkivyskupijoje.</p>
            <div class="px-lg-5 mb-5">
            </div>
            <h2>Požemiai</h2>
            <p class="text-muted mb-4">Vilniaus katedros požemiai – nematoma pastato dalis – pristato šventovės, stovinčios vienoje seniausiai gyvenamų Vilniaus vietų, istoriją, pastato kaitą, čia palaidotus Lietuvos valstybei ir Bažnyčiai nusipelniusius asmenis. Kriptose ir koridoriuose įrengta ekspozicija supažindina su laidojimo tradicijomis,
                archeologiniais radiniais, atveria Karališkąjį mauzoliejų.</p><img class="img-fluid mb-4" src="img/pozemiai.jpg" alt="">
