  ...
  <body>
    ...
    <section class="py-5">
      <div class="container text-center">
        ...
        <h1>Gedimino pilis</h1>
        <ul class="list-inline small text-uppercase mb-0">
          <li class="list-inline-item align-middle"><img class="rounded-circle shadow-sm" src="img/person-1.jpg" alt="" width="40"/></li>
          <li class="list-inline-item me-0 text-muted align-middle">---- </li>
          <li class="list-inline-item align-middle me-0"><a class="fw-bold reset-anchor" href="#!">----</a></li>
        ...
        </div><div class="katedrosDivas"><img class="w-100 py-5" id="katedra" src="img/gedimino.jpg" alt=""></div>
      <div class="container">
        <div class="row gy-5">
          <div class="col-lg-8">
            <p class="lead first-letter-styled lh-4">Gedimino pilies bokštas yra lankomiausias Lietuvos nacionalinio muziejaus padalinys. Jame įkurta ekspozicija supažindina su Vilniaus, kaip politinio Lietuvos Didžiosios Kunigaikštystės centro,
                 istorija ir kviečia savo akimis išvysti nuostabią sostinės panoramą.</p>
            
            <h2>Muziejus</h2>
            <p class="text-muted mb-4">Gedimino pilies bokštas yra lankomiausias Lietuvos nacionalinio muziejaus padalinys. Jame įkurta ekspozicija supažindina su Vilniaus, kaip politinio Lietuvos Didžiosios Kunigaikštystės centro,
                 istorija ir kviečia savo akimis išvysti nuostabią sostinės panoramą. Čia galite rasti Nuo XIV–XV amžiaus kryžiuočių antpuolių išlikusius sviedinius; to paties laikotarpio vieną iš dviejų Lietuvoje rastų arbaleto strėlių su antgaliu, taip pat apeiginį iš rago padarytą kirvelį, puoštą baltiškos svastikos simboliais; kunigaikščio Gedimino 1322–1323 metais popiežiui Jonui XXII ir
                  Europos pirkliams rašytus laiškus; Baltijos keliui skirtą instaliaciją, kuri leis pačiam pasijusti Baltijos kelio dalyviu.</p><img class="img-fluid mb-4" src="img/muziejus.jpg" alt="">
            <ul class="list-check text-muted text-sm mb-5">
            <li class="mb-1">Adresas: Arsenalo g. 5, Vilnius 01143 </li>
            <li class="mb-1">Kaina: suaugusiems 8 eur (Balandis-Rugsėjis), 4 eur moksleiviams, studentams, senjorams.<br> Suaugusiems 6eur (Spalis-Kovas), 3 eur moksleiviams,studentams,senjorams. </li>
            <li class="mb-1">Telefono nr.: +370 5 261 7453 . </li>
            <li class="mb-1">Elektroninis paštas: pilis@lnm.lt </li>
            <li class="mb-1">Svetaine: www.lnm.lt </li>
            <li class="mb-1">Darbo laikas: I-VII: 10:00-20:00.<br>Valstybinių švenčių dienomis muziejus nedirba. </li>
            <h3 class="mb-4">Apžvalgos aikštelė</h3>
            <ul class="list-check text-muted text-sm mb-5">
          ...
          <div class="col-lg-4">
            ...
            <div class="px-4 py-5 bg-light mb-5 text-center">
              <h3 class="h5"><i class="far fa-envelope me-2"></i>Naujienlaiškis</h3>
              <p class="text-sm text-muted">Įrašykite savo elektroninį paštą ir iš mūsų gaukite naujienas apie Vilniuje vykstančius renginius, koncertus ar atvirų durų dienas muziejuose.</p>
              <form action="#">
                <div class="mb-1">
                  <input class="form-control form-control-sm" type="email" name="email" placeholder="El. paštas">
                </div>
                <div class="mb-0">
                  <button class="btn btn-dark w-100 btn-sm" type="submit">Prenumeruoti</button>
                </div>
              </form>
            </div>
            <!-- Latest posts widget -->
