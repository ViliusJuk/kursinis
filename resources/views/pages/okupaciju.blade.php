...
<html>
  ...
  <body>
    ...
    <section class="py-5">
      ...
      </div><div class="katedrosDivas"><img class="w-100 py-5" id="katedra" src="img/okupaciju.jpg" alt=""></div>
      <div class="container">
        <div class="row gy-5">
          <div class="col-lg-8">
            <p class="lead first-letter-styled lh-4">MO muziejus, įkurtas asmenine mokslininkų Danguolės ir Viktoro Butkų iniciatyva, beveik dešimtmetį veikė kaip muziejus be sienų. Sukauptą apie 6 000 modernaus ir šiuolaikinio meno kūrinių kolekciją sudaro Lietuvos dailės aukso fondas nuo 1960-ųjų iki šių dienų.
...
MO muziejaus misija – menas arčiau žmonių, daugiau žmonių prie meno. </p>
